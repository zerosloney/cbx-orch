...
import { saveJson, savePersistedState, loadPersistedState, redactText, now } from "./storage.js";
import { loadConfig, jobDir } from "./state.js";
import { validateWorkspace, validateTestCommand, validatePermissionMode, assertExecutionPolicy, normalizeJobId, normalizeTaskContract } from "./validation.js";
import { normalizeAdaptiveOptions } from "./adaptive-manager.js";
import { snapshotGitBaseline, gitDirtyFingerprint, gitRoot } from "./git-ops.js";
