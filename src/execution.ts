...
import { evaluateBaselineDrift, refreshBaseline, performContextHandshake } from "./baseline.js";
...
import { createHumanGate, parseHumanGate, resolveHumanGate, extendRoundLimit, trackFailure } from "./human-gate.js";
import { evidenceHashes, completionEvidenceValid, parsePendingCompletion, worktreeSha256, structuredAuditRequested, type PendingCompletion } from "./evidence.js";
import { auditAllowsCompletion, criterionDefinitions, reconcileVerifiedProgress, type StructuredAudit, type VerifiedProgress } from "./progress.js";
